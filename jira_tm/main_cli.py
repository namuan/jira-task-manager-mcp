...
from jira_tm.jira_task_manager import JiraTaskManager
...
def _create_basic_task_tools(mcp: FastMCP, manager: JiraTaskManager):
...
def _create_checklist_tools(mcp: FastMCP, manager: JiraTaskManager):
...
def _create_task_query_tools(mcp: FastMCP, manager: JiraTaskManager):
...
def create_task_tools(mcp: FastMCP, manager: JiraTaskManager):
    """Create and register task management tools with MCP instance.

    Args:
        mcp: FastMCP instance
        manager: JiraTaskManager instance
    """
